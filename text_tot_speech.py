...
def speaknow():
    ...
    if (text):
        if(speed == 'Fast'):
            ...
            setvoice()
#icon
image_icon=PhotoImage(file="rumor.png")
...
logo_image=PhotoImage(file="speaker.png")
Label(top_frame, image=logo_image, bg="white").place(x=10, y=5)
...
gender_combobox=Combobox(root,values=['FR', 'EN'], font="arial 14", state='r', width=10)
...
##
imageicon=PhotoImage(file="rumor.png")
